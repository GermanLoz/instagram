...
<div class="content">
<section>
    <div class="content-user-grid">
        <div class="avatar">
            <img src="{{asset('images/avatar.jpg')}}"></img>
        </div>
        <div>
            <div class="info-user">
                <div class="editar-perfil">
                    <h2>pretty_accesorioshs</h2>
                    <a class="editar-perfil-button" href="{{ route('editar-perfil')}}">Editar perfil</a>
                    <button class="options-user">
